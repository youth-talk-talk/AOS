...
import com.example.presentation.ui.component.DropDownComponent
...
private fun CardView(
    ...
    Box(
        modifier =
            Modifier
                .fillMaxWidth()
                .background(color = MaterialTheme.colorScheme.tertiary, shape = RoundedCornerShape(topEnd = r, topStart = r))
