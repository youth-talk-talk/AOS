...
class ReportCommentTest {
    ...
    @Test
    fun givenCommentId_whenReport_thenWorksFine() = runBlocking {
        // given
        val commentId = 72L
        ...
        // when
        val response = sut.reportComments(commentId)
        val recordedRequest = mockWebServer.takeRequest()

        // then
        assertEquals("/api/v1/report/comments/$commentId", recordedRequest.path)
    ...
    @Test
    fun givenAlreadyReportCommentId_whenReport_thenThrows409Exception() = runBlocking {
        // given
        val commentId = 72L
    ...
    @Test
    fun givenMyCommentId_whenReport_thenThrows400Exception() = runBlocking {
        // given
        val commentId = 72L
    ...
    @Test
    fun givenNoExistCommentId_whenReport_thenThrows400Exception() = runBlocking {
        // given
        val commentId = 213123L
